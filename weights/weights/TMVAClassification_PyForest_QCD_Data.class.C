...
Method         : PyRandomForest::PyForest_QCD_Data
TMVA Release   : 4.2.1         [262657]
ROOT Release   : 6.12/04       [396292]
Creator        : viniciusmikuni
Date           : Mon Feb  5 18:19:56 2018
...
FilenameClassifier: "MVA_weights/weights/PyRFModel_PyForest_QCD_Data.PyData" [Store trained classifier in this file]
##
...
NVar 9
simple_chi2                   simple_chi2                   simple_chi2                   simple_chi2                                                     'F'    [0.00896167196333,59680.7382812]
meanDeltaRbtag                meanDeltaRbtag                meanDeltaRbtag                meanDeltaRbtag                                                  'F'    [0.383564323187,5.63277387619]
BDT_Comb                      BDT_Comb                      BDT_Comb                      BDT_Comb                                                        'F'    [-0.994386970997,0.98411411047]
...
class ReadPyForest_QCD_Data : public IClassifierReader {

 public:

   // constructor
   ReadPyForest_QCD_Data( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPyForest_QCD_Data" ),
        fNvars( 9 ),
        fIsNormalised( false )
   {      
 ...
 private:
   ...
   inline double ReadPyForest_QCD_Data::GetMvaValue( const std::vector<double>& inputValues ) const
   {
...
inline void ReadPyForest_QCD_Data::InitTransform_1()
{
   // Normalization transformation, initialisation
   fMin_1[0][0] = 0.00896167196333;
   fMax_1[0][0] = 59680.7382812;
   fMin_1[1][0] = 0.0967559292912;
   fMax_1[1][0] = 34431.8476562;
   fMin_1[2][0] = 0.00896167196333;
   fMax_1[2][0] = 59680.7382812;
   fMin_1[0][1] = 0.396805226803;
   fMax_1[0][1] = 5.39297056198;
   fMin_1[1][1] = 0.383564323187;
   fMax_1[1][1] = 5.63277387619;
   fMin_1[2][1] = 0.383564323187;
   fMax_1[2][1] = 5.63277387619;
   fMin_1[0][2] = -0.994386970997;
   fMax_1[0][2] = 0.98411411047;
   fMin_1[1][2] = -0.99383944273;
   fMax_1[1][2] = 0.73635661602;
   fMin_1[2][2] = -0.994386970997;
   fMax_1[2][2] = 0.98411411047;
   fMin_1[0][3] = -10;
   fMax_1[0][3] = 1;
   fMin_1[1][3] = -10;
   fMax_1[1][3] = 0.999276340008;
   fMin_1[2][3] = -10;
   fMax_1[2][3] = 1;
   fMin_1[0][4] = -10;
   fMax_1[0][4] = 1;
   fMin_1[1][4] = -10;
   fMax_1[1][4] = 0.999539196491;
   fMin_1[2][4] = -10;
   fMax_1[2][4] = 1;
   fMin_1[0][5] = -1;
   fMax_1[0][5] = 1;
...
//_______________________________________________________________________
inline void ReadPyForest_QCD_Data::Transform_1( std::vector<double>& iv, int cls) const
{
...
//_______________________________________________________________________
inline void ReadPyForest_QCD_Data::InitTransform()
{
   InitTransform_1();
}

//_______________________________________________________________________
inline void ReadPyForest_QCD_Data::Transform( std::vector<double>& iv, int sigOrBgd ) const
{
