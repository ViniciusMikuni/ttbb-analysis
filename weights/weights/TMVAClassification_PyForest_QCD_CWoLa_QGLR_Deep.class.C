// Class: ReadPyForest_QCD_CWoLa_QGLR_Deep
...
Method         : PyRandomForest::PyForest_QCD_CWoLa_QGLR_Deep
TMVA Release   : 4.2.1         [262657]
ROOT Release   : 6.12/04       [396292]
Creator        : viniciusmikuni
Date           : Mon Feb 26 13:26:14 2018
...
FilenameClassifier: "MVA_weights/weights/PyRFModel_PyForest_QCD_CWoLa_QGLR_Deep.PyData" [Store trained classifier in this file]
##
...
class ReadPyForest_QCD_CWoLa_QGLR_Deep : public IClassifierReader {

 public:

   // constructor
   ReadPyForest_QCD_CWoLa_QGLR_Deep( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPyForest_QCD_CWoLa_QGLR_Deep" ),
        fNvars( 51 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPyForest_QCD_CWoLa_QGLR_Deep() {
 ...
 private:
   ...
   inline double ReadPyForest_QCD_CWoLa_QGLR_Deep::GetMvaValue( const std::vector<double>& inputValues ) const
   {
