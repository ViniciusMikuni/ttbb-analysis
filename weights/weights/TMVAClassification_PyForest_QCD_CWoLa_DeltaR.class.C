// Class: ReadPyForest_QCD_CWoLa_DeltaR
...
Method         : PyRandomForest::PyForest_QCD_CWoLa_DeltaR
TMVA Release   : 4.2.1         [262657]
ROOT Release   : 6.12/04       [396292]
Creator        : viniciusmikuni
Date           : Mon Feb 26 15:28:18 2018
...
FilenameClassifier: "MVA_weights/weights/PyRFModel_PyForest_QCD_CWoLa_DeltaR.PyData" [Store trained classifier in this file]
##
...
class ReadPyForest_QCD_CWoLa_DeltaR : public IClassifierReader {

 public:

   // constructor
   ReadPyForest_QCD_CWoLa_DeltaR( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadPyForest_QCD_CWoLa_DeltaR" ),
        fNvars( 50 ),
        fIsNormalised( false )
   {      
   ...
   // destructor
   virtual ~ReadPyForest_QCD_CWoLa_DeltaR() {
 ...
 private:
   ...
   inline double ReadPyForest_QCD_CWoLa_DeltaR::GetMvaValue( const std::vector<double>& inputValues ) const
   {
