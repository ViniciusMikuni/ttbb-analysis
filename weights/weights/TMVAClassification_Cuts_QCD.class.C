...
class ReadCuts_QCD : public IClassifierReader {

 public:

   // constructor
   ReadCuts_QCD( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadCuts_QCD" ),
        fNvars( 4 ),
        fIsNormalised( false )
   {      
 ...
 private:
   ...
   // not implemented for class: "ReadCuts_QCD"
};
   inline double ReadCuts_QCD::GetMvaValue( const std::vector<double>& inputValues ) const
   {
