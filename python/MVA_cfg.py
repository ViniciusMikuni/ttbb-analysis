...
batchs = 64
#nneurons = 64
def PyDNN_Opt(bkg, nvar,ncat = 2,activation = 'selu',nneurons=32,opt=Adam(lr=1e-4)):
    act = 'softmax'
    ...
    # model.add(Dense(100,input_dim = nvar,kernel_initializer='lecun_normal', activation='selu',bias_initializer='zeros'))
    # model.add(AlphaDropout(0.5))
    # model.add(Dense(100, activation='selu',kernel_initializer='lecun_normal',bias_initializer='zeros'))
    ...
    model.add(Dense(100, input_dim = nvar, activation='relu',kernel_initializer='he_uniform'))
    ...
    model.add(Dense(ncat,  activation=act,kernel_initializer='he_uniform'))

    # model.add(Dropout(0.2))
    # model.add(BatchNormalization())
    #model.add(Dense(64, activation='relu',bias_initializer='zeros',kernel_initializer='he_uniform',kernel_regularizer=l2()))
    # model.add(BatchNormalization())
