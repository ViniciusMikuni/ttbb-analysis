...
fitCommand = 'combine -M MultiDimFit -d ../workspace.root --rMin 0 --rMax 5 --expectSignal=1 -t -1 --algo singles --freezeNuisanceGroups=extern --freezeParameters {} -n _{} --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_MaxCalls=999999999 --X-rtd MINIMIZER_analytic --robustFit 1 --setCrossingTolerance 1E-5'
