...
def MeasureSystematics(t,mytree,sys,direc):
      ...
      #print nbjets
      if njets >= 7 and nbjets >=2 and njets<=14:
            ...
            for comb in allcomb_:
                  ...
                  UpdateVariables(comb,jets_,mytree.variables,MVA_Only,True)
                  if mytree.variables['prob_chi2'][0] < probcut: continue
                  #f mytree.variables['simple_chi2'][0] < chi2cut: continue
                  passchi2=1
                  w1.UpdateParam(jets_[comb[2]]+jets_[comb[3]])
                  top1.UpdateParam(jets_[comb[0]]+jets_[comb[3]]+jets_[comb[2]])
                  w2.UpdateParam(jets_[comb[5]]+jets_[comb[4]])
            ...
            #print 'my cwola: ',mytree.variables['BDT_CWoLa{0}{1}'.format(sys,direc)][0], ' saved one: ',eval('t.CWoLa_BDT{0}{1}'.format(sys,direc))
            return 1
      else:return 0
